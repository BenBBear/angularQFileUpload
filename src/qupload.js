...
(function() {
    var angularQFileUpload = angular.module('angularQFileUpload', ['ngStorage']);

    angularQFileUpload.service('$qupload', ['$http', '$q', '$localStorage',
            ...
            this.upload = function(config) {
                ...
                var mkfile = function(file, blockRet) {
                    ...
                    $http({
                        ...
                        deferred.resolve(e);
                        delete $localStorage[fileHashKey];
                    }).error(function(e) {
                        deferred.reject(e);
                    });
                };
